                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control " id="employeeid" name="employeeid" placeholder="Enter your name">
                                    </div>
                                </div>
                            </div>  
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control " id="first_name3" name="username" placeholder="Enter your name">
                                    </div>
                                </div>
                            </div>  
                             <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control " id="first_name3" name="fathersname" placeholder="Enter your Father's name">
                                    </div>
                                </div>
                            </div> 
                             <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control " id="first_name3" name="mothersname" placeholder=" Enter your Mother's name">
                                    </div>
                                </div>
                            </div>                         
                            <div class="form-group row">
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <input type="date" style= "width: 100%; "  id="dob" name="dob" >
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control " id="localaddress" name="localaddress" placeholder="Local Address">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control " id="con_password3" name="permanentaddress" placeholder="Permanent Address">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <select name="gender" class="selectpicker"  style="width: 100%; font-family: cursive;">
                                            <option></option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <select name="department"  class="selectpicker"  style="width: 100%; font-family: cursive;">
                                            <option></option>
                    ...
                    <h5 class="heading">Account Login</h5>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <input type="email" class="form-control " id="email" name="email" placeholder="Permanent Address">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control " id="password" name="password" placeholder="Permanent Address">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-9 offset-sm-3">
                                    <button class="btn btn-primary layout_btn_prevent" type="submit"  name="submit">Add Employee</button>
